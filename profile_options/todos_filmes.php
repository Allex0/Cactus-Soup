...
include '../login_register/config.php';
        $result = mysqli_query($conn, "SELECT * FROM filmes f, filme_user fu WHERE f.id = fu.id_filme AND id_user = '$id_user'");
...
<figure class="card">
    ...
    <input type="hidden" name="id" value="';
        ...
        echo '
                ...
                $result2 = mysqli_query($conn, "SELECT * FROM seris s, seris_user su WHERE s.id = su.id_seris AND id_user = '$id_user'");
